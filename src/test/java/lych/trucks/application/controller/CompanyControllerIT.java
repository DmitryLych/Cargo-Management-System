...
public class CompanyControllerIT {
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(request(POST, COMPANY_CONTROLLER_URL)
    ...
    public void fetch() throws Exception {
        ...
        mockMvc.perform(request(GET, COMPANY_CONTROLLER_URL + "/" + companyId)
                .accept(APPLICATION_JSON_UTF8_VALUE)
                .contentType(APPLICATION_JSON_UTF8_VALUE))
                .andDo(print())
    ...
    public void update() throws Exception {
        ...
        mockMvc.perform(request(PUT, COMPANY_CONTROLLER_URL)
                .accept(APPLICATION_JSON_UTF8_VALUE)
                .content(objectMapper.writeValueAsString(request))
                .contentType(APPLICATION_JSON_UTF8_VALUE))
                .andDo(print())
    ...
    public void delete() throws Exception {
        ...
        mockMvc.perform(request(DELETE, COMPANY_CONTROLLER_URL + "/" + companyId)
                .accept(APPLICATION_JSON_UTF8_VALUE)
                .contentType(APPLICATION_JSON_UTF8_VALUE))
                .andDo(print())
                .andExpect(status().isOk());
    ...
    public void fetchAll() throws Exception {
        ...
        mockMvc.perform(request(GET, COMPANY_CONTROLLER_URL)
                .accept(APPLICATION_JSON_UTF8_VALUE)
                .contentType(APPLICATION_JSON_UTF8_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
    ...
    public void fetchByCompanyName() throws Exception {
        ...
        mockMvc.perform(request(GET, COMPANY_CONTROLLER_URL + "/companyName/" + COMPANY_NAME)
                .accept(APPLICATION_JSON_UTF8_VALUE)
                .contentType(APPLICATION_JSON_UTF8_VALUE))
                .andDo(print())
                .andExpect(status().isOk())
