...
public class DriverController {
     ...
     */
    @GetMapping
    public ResponseEntity fetchAllDriversFromCompany(@PathVariable final Integer companyId) {
    ...
    public ResponseEntity fetchDriverByLastNameAndFirstName(@PathVariable final String lastName,
