...
CREATE TABLE companies (
  ...
  user_id          INTEGER CONSTRAINT fk9l5d0fem75e59uwf9upwuf9du REFERENCES users
);
...
CREATE TABLE customers (
  ...
  user_id                  INTEGER CONSTRAINT fkrh1g1a20omjmn6kurd35o3eit REFERENCES users
);
...
CREATE TABLE drivers (
  ...
  truck_fk               INTEGER,
  user_id                INTEGER CONSTRAINT fkfscpnjt46gco44xh86l99rxh7 REFERENCES users
);
